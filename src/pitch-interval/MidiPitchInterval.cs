...
namespace SineVita.Muguet {
    ...
    public sealed class MidiPitchInterval : PitchInterval, IIncrementOperators<MidiPitchInterval> {
        ...
        public static MidiPitchInterval operator +(MidiPitchInterval interval, int upBy) => interval.Incremented(upBy);
        public static MidiPitchInterval operator +(int upBy, MidiPitchInterval interval) => interval.Incremented(upBy);

        public static MidiPitchInterval operator -(MidiPitchInterval interval, int downBy) => interval.Decremented(downBy);
        ...
        private void Increment(int upBy = 1) {
            PitchIntervalIndex += upBy;
        }
        ...
        private void Decrement(int downBy = 1) {
            PitchIntervalIndex -= downBy;
        }
    }
